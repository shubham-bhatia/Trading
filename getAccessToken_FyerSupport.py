...
CLIENT_ID = "XS99684"  # Your Fyers_1 Client ID
PIN = "7777"  # User pin for Fyers_1 account
APP_ID = "JEBUMTMO2I"  # App ID from MyAPI dashboard (https://myapi.fyers.in/dashboard). The format is appId-appType.
# Example: YIXXXXXSE-100. In this code, YIXXXXXSE is the APP_ID and 100 is the APP_TYPE
APP_TYPE = "100"
APP_SECRET = "MTHAV8WWP8"  # App Secret from myapi dashboard (https://myapi.fyers.in/dashboard)
TOTP_SECRET_KEY = "CDX6GOGVODZPTQNNC2YEJMFJGKTCCYIH"  # TOTP secret key, copy the secret while enabling TOTP.
